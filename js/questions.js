...
const QUESTION_BANK = {
  "allgemein": {
    ...
    questions: [
      ...
      {q:"Was ist die offizielle Währung von Japan?", a:["Won","Yen","Yuan","Ringgit"], c:1, diff:1},
      {q:"Wie viele Bundesländer hat Österreich?", a:["8","9","10","7"], c:1, diff:2},
      {q:"Welches Meeres getrennt Europa von Afrika am Bosporen?", a:["Rotes Meer","Mittelmeer","Schwarzes Meer","Ägäis"], c:2, diff:3},
      {q:"Was ist die Hauptstadt von Neuseeland?", a:["Auckland","Wellington","Christchurch","Hamilton"], c:1, diff:2},
      {q:"Welcher Wüste liegt in Südamerika?", a:["Sahara","Atacama","Kalahari","Gobi"], c:1, diff:2},
      {q:"Wie viele Zeitzonen hat Russland?", a:["9","11","13","7"], c:1, diff:3},
      {q:"Welcher Ozean liegt zwischen Afrika und Australien?", a:["Atlantik","Indischer Ozean","Pazifik","Arktik"], c:1, diff:2},
      {q:"Was ist die Hauptstadt von Portugal?", a:["Porto","Lissabon","Faro","Coimbra"], c:1, diff:1},
      {q:"Welches Land grenzt NICHT an die Schweiz?", a:["Frankreich","Italien","Österreich","Slowenien"], c:3, diff:1},
    ]
  },
  "geografie": {
  ...
  "sport": {
    ...
    questions: [
      ...
      {q:"Wie viele Ringe hat das olympische Symbol?", a:["4","5","6","7"], c:1, diff:1},
      ...
      {q:"Welche Sportart wird beim 'Tour de France' ausgeübt?", a:["Radsport","Motorsport","Skifahren","Joggen"], c:0, diff:1},
      {q:"Wie viele Minuten dauert eine Hälfte beim Eishockey?", a:["15","20","25","30"], c:1, diff:2},
      {q:"In welchem Land wurde der Davis Cup im Tennis erstmals ausgetragen?", a:["USA","Grossbritannien","Australien","Frankreich"], c:1, diff:3},
      {q:"Welcher Schweizer Fussballer spielte lange beim AC Mailand?", a:["Xherdan Shaqiri","Granit Xhaka","Ciriaco Stampa","Kubilay Türkyilmaz"], c:3, diff:3},
      {q:"Was ist im Schweizer Sport die höchste Volleyball-Liga?", a:["NLA","Super League","Nationalliga A","LNA"], c:2, diff:3},
      {q:"Bei welchem Sport gibt es einen 'Bullseye'?", a:["Bogenschiessen","Darts","Golf","Billard"], c:1, diff:1},
      {q:"Wie heisst der Schweizer Formel-1-Fahrer, der 2016 schied (Rückmeldung)?", a:["Sébastien Buemi","Romain Grosjean","Charles Leclerc","Nico Hülkenberg"], c:2, diff:3},
      {q:"Welches Land gewann die Fussball-WM 2018?", a:["Deutschland","Brasilien","Frankreich","Spanien"], c:2, diff:1},
      {q:"Aus wie vielen Bahnen besteht eine olympische Laufbahn?", a:["6","8","10","9"], c:1, diff:2},
      {q:"In welchem Jahr fanden die Olympischen Sommerspiele in Paris statt (letzte)?", a:["2012","2016","2024","2021"], c:2, diff:2},
      {q:"Wie viele Spieler hat ein Eishockeyteam auf dem Eis (inkl. Torhüter)?", a:["5","6","7","4"], c:1, diff:2},
    ]
  },
  "geschichte": {
    ...
    questions: [
      ...
      {q:"Wer war der erste Bundeskanzler der Bundesrepublik Deutschland?", a:["Willy Brandt","Konrad Adenauer","Helmut Kohl","Ludwig Erhard"], c:1, diff:2},
      {q:"In welchem Jahr endete der Erste Weltkrieg?", a:["1916","1917","1918","1920"], c:2, diff:2},
      {q:"Wie hiess das Schiff, mit dem die Pilger 1620 nach Amerika fuhren?", a:["Santa Maria","Mayflower","Endeavour","Beagle"], c:1, diff:2},
      {q:"Wer eroberte die Halbinsel der Azteken (Mexiko) im 16. Jh.?", a:["Francisco Pizarro","Hernán Cortés","Vasco da Gama","Magellan"], c:1, diff:3},
      {q:"In welchem Jahr fand die Erste Französische Revolution statt?", a:["1776","1789","1815","1799"], c:1, diff:3},
      {q:"Welches Reich regierte Kleopatra?", a:["Rom","Griechenland","Ägypten","Persien"], c:2, diff:2},
      {q:"Wer baute das erste Dampfschiff, das den Atlantik überquerte?", a:["James Watt","Robert Fulton","Isambard Brunel","Samuel Morse"], c:1, diff:3},
    ]
  },
  "wissen-technik": {
    ...
    questions: [
      ...
      {q:"Wofür steht 'CPU'?", a:["Central Processing Unit","Computer Personal Unit","Central Program Utility","Core Processing Unit"], c:0, diff:1},
      {q:"Wie viele Bytes hat ein Kilobyte (genauer: KiB)?", a:["1000","1024","100","2048"], c:1, diff:2},
      {q:"Wer entwickelte das erste Programm (Analytical Engine)?", a:["Alan Turing","Ada Lovelace","Charles Babbage","Grace Hopper"], c:2, diff:3},
      {q:"Was bedeutet 'HTML'?", a:["HyperText Markup Language","Home Tool Markup Language","Hyperlink Text Mode Language","High Text Machine Link"], c:0, diff:1},
      {q:"Welches Element kommt in jedem Computerchip?", a:["Kupfer","Silizium","Aluminium","Gold"], c:1, diff:2},
      {q:"Was ist der Name des weltweit grössten sozialen Netzwerks (Nutzerzahl)?", a:["Instagram","Facebook","TikTok","X"], c:1, diff:2},
      {q:"Wie heisst der Prozess, der Text in Maschinencode übersetzt?", a:["Komponenten","Compiler","Composer","Cluster"], c:1, diff:2},
      {q:"In welchem Jahr wurde das erste iPhone vorgestellt?", a:["2005","2007","2009","2011"], c:1, diff:2},
      {q:"Wofür steht 'GB' bei Datenspeicher?", a:["Gigabyte","Gigabit","Gigabaud","General Byte"], c:0, diff:1},
      {q:"Welches Land entwickelte ursprünglich die KI-Modelle 'DeepSeek'?", a:["USA","China","Japan","Südkorea"], c:1, diff:3},
    ]
  },
  "musik": {
    name: "Musik", emoji: "🎵",
    questions: [
      ...
      {q:"Wie heisst die Sängerin von 'Rolling in the Deep'?", a:["Adele","Beyoncé","Rihanna","Amy Winehouse"], c:0, diff:1},
      {q:"Welches Instrument spielte Louis Armstrong?", a:["Klavier","Trompete","Saxofon","Geige"], c:1, diff:2},
      {q:"Wie viele Saiten hat eine Violine?", a:["3","4","5","6"], c:1, diff:2},
      {q:"Wer war der Leadsänger von Queen?", a:["Elton John","Freddie Mercury","David Bowie","Mick Jagger"], c:1, diff:1},
      {q:"Welche Musikrichtung entstand im New Orleans der 1900er?", a:["Rock","Jazz","Pop","Reggae"], c:1, diff:2},
      {q:"Wie heisst das zweite Album der Beatles (1963)?", a:["Help","With the Beatles","Revolver","Rubber Soul"], c:1, diff:3},
      {q:"Welcher Komponist schrieb die 'Zauberflöte'?", a:["Beethoven","Mozart","Haydn","Bach"], c:1, diff:2},
      {q:"Welches Land ist für den Flamenco bekannt?", a:["Portugal","Italien","Spanien","Frankreich"], c:2, diff:1},
      {q:"Wie heisst der berühmte Geiger, der 'Zigeunerweisen' spielte?", a:["Paganini","Itzhak Perlman","Yehudi Menuhin","Anne-Sophie Mutter"], c:2, diff:3},
    ]
  },
  "filme": {
    name: "Film & TV", emoji: "🎬",
    questions: [
      ...
      {q:"Welcher Regisseur drehte 'Pulp Fiction'?", a:["Martin Scorsese","Quentin Tarantino","Steven Spielberg","Christopher Nolan"], c:1, diff:2},
      {q:"Welcher Film gewann den Oscar 'Bester Film' 2020?", a:["1917","Parasite","Joker","Once Upon a Time"], c:1, diff:3},
      {q:"In welchem Film spielte Tom Hanks den 'Forrest Gump'?", a:["Philadelphia","Forrest Gump","Cast Away","Big"], c:1, diff:1},
      {q:"Wie heisst der Hauptcharakter in 'Star Wars' (Klassische Trilogie)?", a:["Hans Solo","Luke Skywalker","Anakin","Obi-Wan"], c:1, diff:1},
      {q:"Welcher Film handelt vom Boxer Rocky Balboa?", a:["Rambo","Rocky","Creed","Deliverance"], c:1, diff:1},
      {q:"Webserie von Netflix mit El Camino-Spin-off?", a:["Narcos","Breaking Bad","Ozark","Stranger Things"], c:1, diff:2},
      {q:"Wer führte Regie bei 'Inception'?", a:["James Cameron","Christopher Nolan","Zack Snyder","Ridley Scott"], c:1, diff:2},
      {q:"Wie heisst der Pirat in 'Fluch der Karibik'?", a:["Blackbeard","Jack Sparrow","Barbossa","Will Turner"], c:1, diff:1},
      {q:"Welcher Zeichentrickfilm zeigt einen Löwen als König?", a:["Madagascar","Der König der Löwen","Tarzan","Aladdin"], c:1, diff:1},
      {q:"In welcher Stadt spielt 'Freunde' (Friends)?", a:["Los Angeles","New York","Chicago","Boston"], c:1, diff:2},
      {q:"Welcher Film gewann 1998 den Oscar für den besten Film?", a:["Titanic","Good Will Hunting","LA Confidential","As Good as It Gets"], c:0, diff:3},
    ]
  }
};
